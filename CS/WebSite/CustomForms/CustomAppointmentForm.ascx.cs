...
public partial class AppointmentForm : SchedulerFormControl {
	...
	public override void DataBind() {
        ...
        btnDelete.ClientSideEvents.Click = string.Format("function(){{ if (confirm('Are you sure that you want to delete this appointment?')) aspxAppointmentDelete('{0}'); }}", container.Control.ClientID); 
