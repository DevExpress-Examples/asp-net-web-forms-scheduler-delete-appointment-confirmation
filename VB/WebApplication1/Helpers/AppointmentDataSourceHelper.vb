...
Namespace WebApplication1.Helpers
	...
	Public Class CustomAppointment
		...
		Private privateUserIDs As String
		Public Property UserIDs() As String
			...
			End Set
		End Property
		Private privateHostNotifications As String
		Public Property HostNotifications() As String
			Get
				Return privateHostNotifications
			End Get
			Set(ByVal value As String)
				privateHostNotifications = value
			End Set
		End Property
	End Class
End Namespace